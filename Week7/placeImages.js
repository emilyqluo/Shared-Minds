...
input_image_field.value = "Generate an amazing image";
input_image_field.size = 50;
input_image_field.style.padding = "10px";
input_image_field.style.border = "2px solid #ccc";
input_image_field.style.borderRadius = "5px";
input_image_field.style.fontSize = "16px";
input_image_field.style.width = "300px"; 
...
function init3D() {
    ...
    let panotexture = new THREE.TextureLoader().load("./clouds.jpg");
